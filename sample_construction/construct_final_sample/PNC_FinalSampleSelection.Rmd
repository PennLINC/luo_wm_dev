...
```{r}
sub_id <- read.table("/cbica/projects/luo_wm_dev/two_axes_manuscript/input/PNC/subject_list/PNC_subject_list_babs.txt", header = T)
demographics.temp <- read.csv("/cbica/projects/luo_wm_dev/two_axes_manuscript/input/PNC/sample_selection_files/PNC_WMDev_TempSampleDemographics_N1145_age8to23.csv")
dwi.qc.temp <- read.csv("/cbica/projects/luo_wm_dev/two_axes_manuscript/input/PNC/sample_selection_files/PNC_WMDev_TempSampleQCMetrics_N1145_age8to23.csv")
```
...
PNC_all <- fread("/cbica/projects/luo_wm_dev/input/PNC/derivatives/tract_profiles/all_subjects/collated_tract_profiles_nocovbat_tmp.tsv") # takes a while to load
...
write.table(subjects_to_exclude, "/cbica/projects/luo_wm_dev/two_axes_manuscript/input/PNC/sample_selection_files/subs_missing_tracts.txt", col.names=T, row.names=F, quote = TRUE)
...
write.table(PNC_all_with_allowed, "/cbica/projects/luo_wm_dev/two_axes_manuscript/input/PNC/derivatives/tract_profiles/all_subjects/collated_tract_profiles_nocovbat.tsv", row.names = FALSE)
...
write.table(sub_id, "/cbica/projects/luo_wm_dev/two_axes_manuscript/input/PNC/subject_list/final_sample/PNC_WMDev_FinalSample.txt", col.names=T, row.names=F, quote = TRUE)
write.csv(merge(demographics.final, dwi.qc.final), "/cbica/projects/luo_wm_dev/two_axes_manuscript/input/PNC/sample_selection_files/final_sample/PNC_WMDev_FinalSampleDemoQC.csv", quote = F, row.names = F)
```

## Demographics table
```{r}
final_sample <- read.csv("/cbica/projects/luo_wm_dev/two_axes_manuscript/input/PNC/sample_selection_files/final_sample/PNC_WMDev_FinalSampleDemoQC.csv", header=T)
