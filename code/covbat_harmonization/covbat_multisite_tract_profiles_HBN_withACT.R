...
data_root <- "/cbica/projects/luo_wm_dev/input/HBN/derivatives/tract_profiles_ACT_v2/"
output_dir <- "/cbica/projects/luo_wm_dev/two_axes/input/HBN/derivatives/tract_profiles_ACT_v2/"
...
if (dir.exists(paste0(output_dir, "all_subjects"))) {
  print(paste(paste0(output_dir, "all_subjects"), "already exists"))
} else {
  dir.create(paste0(output_dir, "all_subjects"), recursive = TRUE)
  print(paste(paste0(output_dir, "all_subjects"), "created"))
}
...
# save out!
saveRDS(merged_covbat_all, sprintf("%1$s/all_subjects/collated_tract_profiles_final.RData", output_dir))
