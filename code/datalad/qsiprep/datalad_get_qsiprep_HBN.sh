...
#SBATCH --error=/cbica/projects/luo_wm_dev/two_axes/code/logs/datalad/HBN/qsiprep_%j.err
...
no_zip_file_list="/cbica/projects/luo_wm_dev/two_axes/input/HBN/sample_selection_files/missing_qsiprep.txt"
> $no_zip_file_list
