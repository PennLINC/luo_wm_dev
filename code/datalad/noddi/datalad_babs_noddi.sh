...
output_file="/cbica/projects/luo_wm_dev/two_axes/code/logs/datalad/${dataset}/babs_mergeds_noddi_${dataset}_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out"
error_file="/cbica/projects/luo_wm_dev/two_axes/code/logs/datalad/${dataset}/babs_mergeds_noddi_${dataset}_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err"
exec > "${output_file}"
exec 2> "${error_file}"

# Directories
dest_dir="/cbica/projects/luo_wm_dev/input/${dataset}/derivatives/noddi"
src_dir="/cbica/projects/luo_wm_dev/input/${dataset}/derivatives/babs_noddi/merge_ds"
...
for zip_file in $(find . -name 'sub*zip'); do
    ...
    declare -a patterns=(
    "gmNODDI:qsirecon-gmNODDI/${sub_id}/ses-[^/]+/dwi/.*noddi_mdp-icvf_dwimap\.nii\.gz"
    "gmNODDI:qsirecon-gmNODDI/${sub_id}/ses-[^/]+/dwi/.*noddi_mdp-isovf_dwimap\.nii\.gz"
    "gmNODDI:qsirecon-gmNODDI/${sub_id}/ses-[^/]+/dwi/.*noddi_mdp-od_dwimap\.nii\.gz"
    "wmNODDI:qsirecon-wmNODDI/${sub_id}/ses-[^/]+/dwi/.*noddi_mdp-icvf_dwimap\.nii\.gz"
    "wmNODDI:qsirecon-wmNODDI/${sub_id}/ses-[^/]+/dwi/.*noddi_mdp-isovf_dwimap\.nii\.gz"
    "wmNODDI:qsirecon-wmNODDI/${sub_id}/ses-[^/]+/dwi/.*noddi_mdp-od_dwimap\.nii\.gz"
  )
