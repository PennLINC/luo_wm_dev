...
#SBATCH --error=/cbica/projects/luo_wm_dev/two_axes/code/logs/datalad/PNC/freesurfer_%j.err
...
no_zip_file_list="/cbica/projects/luo_wm_dev/two_axes/input/PNC/sample_selection_files/missing_freesurfer.txt"
> $no_zip_file_list
