...
source("/cbica/projects/luo_wm_dev/two_axes/code/results/main_figures_functions.R") # using some functions from main figures
...
text_HCPD_HBN <- bquote(italic(r) == .(cor_HCPD_HBN) * "," ~ italic(p[perm]) == .(format(round(HCPD_HBN_ageeffect_perm$p_value, 5), scientific = FALSE)))
HCPD_HBN_ageeffects_plot <- hex_plot(HCPD_HBN_ageeffects, "HCPD", "HBN", text_HCPD_HBN, ylim1 = 0 , ylim2 = 0.64, xlim1 = 0, xlim2 = 0.62, x_text = 0, y_text = 0.64, bin_size = 9)

text_HCPD_PNC <- bquote(italic(r) == .(cor_HCPD_PNC) * "," ~ italic(p[perm]) == .(format(round(HCPD_PNC_ageeffect_perm$p_value, 5), scientific = FALSE)))
HCPD_PNC_ageeffects_plot <- hex_plot(HCPD_PNC_ageeffects, "HCPD", "PNC", text_HCPD_PNC, ylim1 = 0 , ylim2 = 0.64, xlim1 = 0, xlim2 = 0.62, x_text = 0, y_text = 0.64, bin_size = 9)

text_HBN_PNC <- bquote(italic(r) == .(cor_HBN_PNC) * "," ~ italic(p[perm]) == .(format(round(PNC_HBN_ageeffect_perm$p_value, 5), scientific = FALSE)))
HBN_PNC_ageeffects_plot <- hex_plot(HBN_PNC_ageeffects, "HBN", "PNC", text_HBN_PNC, ylim1 = 0 , ylim2 = 0.64, xlim1 = 0, xlim2 = 0.62, x_text = 0, y_text = 0.64, bin_size = 9)
...
ageeffects_plots <- ggarrange(HCPD_PNC_ageeffects_plot, HBN_PNC_ageeffects_plot, HCPD_HBN_ageeffects_plot, nrow = 1, common.legend=T, legend = c("bottom"), labels = "auto", font.label = list(size=24))
...
#ggsave(paste0(suppfig_dir, "supp_cross_dataset_hexplots.png"), grid.arrange(arrangeGrob(ageeffects_plots, top = title.grob)), height = 7, width = 20, units = "in")
```
...
```{r load CST NEST}
cst_PNC <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Corticospinal_bin5_clip5_1sided.RData")
NEST_PNC <- data.frame(c("Corticospinal", cst_PNC$pval, "PNC")) %>% setNames(c("tract_label", "pval_fdr_all", "Dataset"))

cst_HCPD <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/HCPD/NEST/dti_md/Corticospinal_bin5_clip5_1sided.RData")
NEST_HCPD <- data.frame(c("Corticospinal", cst_HCPD$pval, "HCP-D")) %>% setNames(c("tract_label", "pval_fdr_all", "Dataset"))

cst_HBN <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/HBN/NEST/dti_md/Corticospinal_bin5_clip5_1sided.RData")
...
PNC_tractlevel_SA_pearsons <- read.csv('/cbica/projects/luo_wm_dev/two_axes/output/PNC/suppfigs_spintests/supp_tractlevel_pearson_pspin_allendpoints.csv')
HCPD_tractlevel_SA_pearsons <- read.csv('/cbica/projects/luo_wm_dev/two_axes/output/HCPD/suppfigs_spintests/supp_tractlevel_pearson_pspin_allendpoints.csv')
HBN_tractlevel_SA_pearsons <- read.csv('/cbica/projects/luo_wm_dev/two_axes/output/HBN/suppfigs_spintests/supp_tractlevel_pearson_pspin_allendpoints.csv')
avgdatasets_tractlevel_SA_pearsons <- read.csv('/cbica/projects/luo_wm_dev/two_axes/output/avgdatasets/suppfigs_spintests/supp_tractlevel_pearson_pspin_allendpoints.csv')
...
PNC_tractlevel_SA_ttest_p <- read.csv("/cbica/projects/luo_wm_dev/two_axes/output/PNC/suppfigs_spintests/supp_tractlevel_pearson_ttest_pspin_maturedonly.csv")
HCPD_tractlevel_SA_ttest_p <- read.csv("/cbica/projects/luo_wm_dev/two_axes/output/HCPD/suppfigs_spintests/supp_tractlevel_pearson_ttest_pspin_maturedonly.csv")
HBN_tractlevel_SA_ttest_p <- read.csv("/cbica/projects/luo_wm_dev/two_axes/output/HBN/suppfigs_spintests/supp_tractlevel_pearson_ttest_pspin_maturedonly.csv")
avgdatasets_tractlevel_SA_ttest_p <- read.csv("/cbica/projects/luo_wm_dev/two_axes/output/avgdatasets/suppfigs_spintests/supp_tractlevel_pearson_ttest_pspin_maturedonly.csv")
...
# Supplementary Figure 4. Correspondence of mean diffusivity age effect and age of maturation. 
```{r age of mat vs age effect correlation, fig.height = 7, fig.width = 18}
# add abs value of age effect
ageeffect.fdr_dfs$PNC_ageeffects <- ageeffect.fdr_dfs$PNC_ageeffects %>% mutate(abs_GAM.smooth.AdjRsq = abs(GAM.smooth.AdjRsq))
ageeffect.fdr_dfs$HCPD_ageeffects <- ageeffect.fdr_dfs$HCPD_ageeffects %>% mutate(abs_GAM.smooth.AdjRsq = abs(GAM.smooth.AdjRsq))
ageeffect.fdr_dfs$HBN_ageeffects <- ageeffect.fdr_dfs$HBN_ageeffects %>% mutate(abs_GAM.smooth.AdjRsq = abs(GAM.smooth.AdjRsq))

# correlations
cor_PNC <- round(cor.test(ageeffect.fdr_dfs$PNC_ageeffects$abs_GAM.smooth.AdjRsq, ageeffect.fdr_dfs$PNC_ageeffects$smooth.decrease.offset)$estimate, 2)
cor_HCPD <- round(cor.test(ageeffect.fdr_dfs$HCPD_ageeffects$abs_GAM.smooth.AdjRsq, ageeffect.fdr_dfs$HCPD_ageeffects$smooth.decrease.offset)$estimate, 2)
cor_HBN <- round(cor.test(ageeffect.fdr_dfs$HBN_ageeffects$abs_GAM.smooth.AdjRsq, ageeffect.fdr_dfs$HBN_ageeffects$smooth.decrease.offset)$estimate, 2)

# perm p-value
PNC_age_measures_perm <- perm_cor_test(ageeffect.fdr_dfs$PNC_ageeffects$GAM.smooth.AdjRsq, ageeffect.fdr_dfs$PNC_ageeffects$smooth.decrease.offset)
HCPD_age_measures_perm <- perm_cor_test(ageeffect.fdr_dfs$HCPD_ageeffects$GAM.smooth.AdjRsq, ageeffect.fdr_dfs$HCPD_ageeffects$smooth.decrease.offset)
HBN_age_measures_perm <- perm_cor_test(ageeffect.fdr_dfs$HBN_ageeffects$GAM.smooth.AdjRsq, ageeffect.fdr_dfs$HBN_ageeffects$smooth.decrease.offset)


text_PNC <- bquote(italic(r) == .(cor_PNC) * "," ~ italic(p[perm]) == .(format(round(PNC_age_measures_perm$p_value, 4), scientific = FALSE)))
PNC_age_measures_plot <- hex_plot(ageeffect.fdr_dfs$PNC_ageeffects, "abs_GAM.smooth.AdjRsq", "smooth.decrease.offset", text_PNC, ylim1 = 13 , ylim2 = 24.5, xlim1 = 0, xlim2 = 0.62, x_text = 0, y_text = 24.5, bin_size = 10) + 
  labs(x = "Mean Diffusivity Age Effect", y = "Age of Maturation", title = "PNC") + 
  theme(plot.title = element_text(hjust=0.5))

text_HCPD <- bquote(italic(r) == .(cor_HCPD) * "," ~ italic(p[perm]) == .(format(round(HCPD_age_measures_perm$p_value, 4), scientific = FALSE)))
HCPD_age_measures_plot <- hex_plot(ageeffect.fdr_dfs$HCPD_ageeffects, "abs_GAM.smooth.AdjRsq", "smooth.decrease.offset", text_HCPD, ylim1 = 13 , ylim2 = 24.5, xlim1 = 0, xlim2 = 0.62, x_text = 0, y_text = 24.5, bin_size = 10)  + 
  labs(x = "Mean Diffusivity Age Effect", y = "Age of Maturation", title = "HCP-D") + 
  theme(plot.title = element_text(hjust=0.5))

text_HBN <- bquote(italic(r) == .(cor_HBN) * "," ~ italic(p[perm]) == .(format(round(HBN_age_measures_perm$p_value, 4), scientific = FALSE)))
HBN_age_measures_plot <- hex_plot(ageeffect.fdr_dfs$HBN_ageeffects, "abs_GAM.smooth.AdjRsq", "smooth.decrease.offset", text_HBN, ylim1 = 13 , ylim2 = 24.5, xlim1 = 0, xlim2 = 0.62, x_text = 0, y_text = 24.5, bin_size = 10) + 
  labs(x = "Mean Diffusivity Age Effect", y = "Age of Maturation", title = "HBN") + 
  theme(plot.title = element_text(hjust=0.5))

# get the maximum bin counts from all datasets
max_count_PNC <- max(ggplot_build(PNC_age_measures_plot)$data[[1]]$count, na.rm = TRUE)
max_count_HCPD <- max(ggplot_build(HCPD_age_measures_plot)$data[[1]]$count, na.rm = TRUE)
max_count_HBN  <- max(ggplot_build(HBN_age_measures_plot)$data[[1]]$count, na.rm = TRUE)
global_max_count <- max(max_count_PNC, max_count_HCPD, max_count_HBN)
scale_limits <- c(0, global_max_count)
PNC_age_measures_plot <- PNC_age_measures_plot +
  paletteer::scale_fill_paletteer_c("ggthemes::Blue-Green Sequential", 
                                    direction = -1, 
                                    limits = scale_limits, 
                                    oob = scales::squish)
HCPD_age_measures_plot <- HCPD_age_measures_plot +
  paletteer::scale_fill_paletteer_c("ggthemes::Blue-Green Sequential", 
                                    direction = -1, 
                                    limits = scale_limits, 
                                    oob = scales::squish)

HBN_age_measures_plot <- HBN_age_measures_plot +
  paletteer::scale_fill_paletteer_c("ggthemes::Blue-Green Sequential", 
                                    direction = -1, 
                                    limits = scale_limits, 
                                    oob = scales::squish)
...
ggarrange(PNC_age_measures_plot, HCPD_age_measures_plot, HBN_age_measures_plot, nrow = 1, common.legend = T, legend = "bottom", labels = "auto", font.label = list(size=24))
ggsave(paste0(suppfig_dir, "supp_age_measures_hexplots.png"), ggarrange(PNC_age_measures_plot, HCPD_age_measures_plot, HBN_age_measures_plot, nrow = 1, common.legend = T, legend = "bottom", labels = "auto", font.label = list(size=24)), height = 7, width = 20, units = "in")
```
...
# load pvalues
PNC_parcellevel_SA_ttest_p <- read.csv("/cbica/projects/luo_wm_dev/two_axes/output/PNC/suppfigs_spintests/supp_parcellevel_pearson_pspin.csv")
HCPD_parcellevel_SA_ttest_p <- read.csv("/cbica/projects/luo_wm_dev/two_axes/output/HCPD/suppfigs_spintests/supp_parcellevel_pearson_pspin.csv")
HBN_parcellevel_SA_ttest_p <- read.csv("/cbica/projects/luo_wm_dev/two_axes/output/HBN/suppfigs_spintests/supp_parcellevel_pearson_pspin.csv")
avgdatasets_parcellevel_SA_ttest_p <- read.csv("/cbica/projects/luo_wm_dev/two_axes/output/avgdatasets/suppfigs_spintests/supp_parcellevel_pearson_pspin_avgdatasets.csv")
...
annot_text_HBN <-  bquote(paste(italic("r"), " = ", .(round(HBN_parcellevel_SA_ttest_p$rho.emp, 2)), ", ", 
                                                      italic("p"[spin]), " = ", .(round(HBN_parcellevel_SA_ttest_p$p.perm, 3))))
...
agg_SA_parcel_plot_final <- ggarrange(agg_SA_parcel_PNC, agg_SA_parcel_HCPD, agg_SA_parcel_HBN, agg_SA_parcel_avgdatasets, ncol = 4, labels = 'auto', font.label = list(size = 24))
...
for (df_name in names(callosum_norm_avgs)) {
  write.csv(callosum_norm_avgs[[df_name]], paste0(glass_brain_dir, "/", df_name, "_avg_dev_supp.csv"), row.names = FALSE)
}

for (df_name in names(assoc_cst_avgs)) {
  write.csv(assoc_cst_avgs[[df_name]], paste0(glass_brain_dir, "/", df_name, "_avg_dev_supp.csv"), row.names = FALSE)
}
```
...
NEST_PNC <- data.frame(cbind(callosal_tracts, p.adjust(unlist(c(cc_af_PNC$pval, cc_mot_PNC$pval, cc_occ_PNC$pval, cc_orb_PNC$pval, cc_pp_PNC$pval, cc_sf_PNC$pval, cc_sp_PNC$pval, cc_tm_PNC$pval)), method=c("fdr")), rep("PNC", 8))) %>% setNames(c("tract_label", "pval_fdr_all", "Dataset"))
...
NEST_HCPD <- data.frame(cbind(callosal_tracts, p.adjust(unlist(c(cc_af_HCPD$pval, cc_mot_HCPD$pval, cc_occ_HCPD$pval, cc_orb_HCPD$pval, cc_pp_HCPD$pval, cc_sf_HCPD$pval, cc_sp_HCPD$pval, cc_tm_HCPD$pval)), method=c("fdr")), rep("HCP-D", 8))) %>% setNames(c("tract_label", "pval_fdr_all", "Dataset"))

# HBN
cc_af_HBN <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/HBN/NEST/dti_md/Callosum_Anterior_Frontal_bin5_clip5_1sided_withACT.RData")
cc_mot_HBN <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/HBN/NEST/dti_md/Callosum_Motor_bin5_clip5_1sided_withACT.RData")
cc_occ_HBN <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/HBN/NEST/dti_md/Callosum_Occipital_bin5_clip5_1sided_withACT.RData")
cc_orb_HBN <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/HBN/NEST/dti_md/Callosum_Orbital_bin5_clip5_1sided_withACT.RData")
cc_pp_HBN <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/HBN/NEST/dti_md/Callosum_Posterior_Parietal_bin5_clip5_1sided_withACT.RData")
cc_sf_HBN <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/HBN/NEST/dti_md/Callosum_Superior_Frontal_bin5_clip5_1sided_withACT.RData")
cc_sp_HBN <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/HBN/NEST/dti_md/Callosum_Superior_Parietal_bin5_clip5_1sided_withACT.RData")
cc_tm_HBN <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/HBN/NEST/dti_md/Callosum_Temporal_bin5_clip5_1sided_withACT.RData")
 
NEST_HBN <- data.frame(cbind(callosal_tracts, p.adjust(unlist(c(cc_af_HBN$pval, cc_mot_HBN$pval, cc_occ_HBN$pval, cc_orb_HBN$pval, cc_pp_HBN$pval, cc_sf_HBN$pval, cc_sp_HBN$pval, cc_tm_HBN$pval)), method=c("fdr")), rep("HBN", 8))) %>% setNames(c("tract_label", "pval_fdr_all", "Dataset"))
```
...
PNC_lh_GM <- read.csv("/cbica/projects/luo_wm_dev/two_axes/input/PNC/derivatives/gyral_hops/all_subjects/lh_GM_count.csv")
PNC_rh_GM <- read.csv("/cbica/projects/luo_wm_dev/two_axes/input/PNC/derivatives/gyral_hops/all_subjects/rh_GM_count.csv")
PNC_lh_WM <- read.csv("/cbica/projects/luo_wm_dev/two_axes/input/PNC/derivatives/gyral_hops/all_subjects/lh_WM_count.csv")
PNC_rh_WM <- read.csv("/cbica/projects/luo_wm_dev/two_axes/input/PNC/derivatives/gyral_hops/all_subjects/rh_WM_count.csv")
...
# Supplementary Table 2: Methods: Deep-Superficial NEST with different bin sizes (bin size = 3, 5, 7, 10)
```{r load deep to superficial NEST results bin3}
tracts <- c("Callosum Anterior Frontal", "Callosum Motor", "Callosum Occipital", "Callosum Orbital", "Callosum Posterior Parietal", "Callosum Superior Frontal", "Callosum Superior Parietal", "Callosum Temporal", "Arcuate", "Inferior Fronto-occipital", "Inferior Longitudinal", "Posterior Arcuate", "Superior Longitudinal", "Uncinate", "Vertical Occipital")

# PNC
# bin size = 3
arc_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Arcuate_bin3_clip5_1sided.RData")
ifo_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Inferior_Fronto_occipital_bin3_clip5_1sided.RData")
ilf_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Inferior_Longitudinal_bin3_clip5_1sided.RData")
parc_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Posterior_Arcuate_bin3_clip5_1sided.RData")
slf_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Superior_Longitudinal_bin3_clip5_1sided.RData")
unc_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Uncinate_bin3_clip5_1sided.RData")
vof_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Vertical_Occipital_bin3_clip5_1sided.RData")

cc_af_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Anterior_Frontal_bin3_clip5_1sided.RData")
cc_mot_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Motor_bin3_clip5_1sided.RData")
cc_occ_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Occipital_bin3_clip5_1sided.RData")
cc_orb_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Orbital_bin3_clip5_1sided.RData")
cc_pp_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Posterior_Parietal_bin3_clip5_1sided.RData")
cc_sf_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Superior_Frontal_bin3_clip5_1sided.RData")
cc_sp_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Superior_Parietal_bin3_clip5_1sided.RData")
cc_tm_PNC_bin3 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Temporal_bin3_clip5_1sided.RData")
...
# bin size = 5
arc_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Arcuate_bin5_clip5_1sided.RData")
ifo_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Inferior_Fronto_occipital_bin5_clip5_1sided.RData")
ilf_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Inferior_Longitudinal_bin5_clip5_1sided.RData")
parc_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Posterior_Arcuate_bin5_clip5_1sided.RData")
slf_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Superior_Longitudinal_bin5_clip5_1sided.RData")
unc_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Uncinate_bin5_clip5_1sided.RData")
vof_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Vertical_Occipital_bin5_clip5_1sided.RData")

cc_af_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Anterior_Frontal_bin5_clip5_1sided.RData")
cc_mot_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Motor_bin5_clip5_1sided.RData")
cc_occ_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Occipital_bin5_clip5_1sided.RData")
cc_orb_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Orbital_bin5_clip5_1sided.RData")
cc_pp_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Posterior_Parietal_bin5_clip5_1sided.RData")
cc_sf_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Superior_Frontal_bin5_clip5_1sided.RData")
cc_sp_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Superior_Parietal_bin5_clip5_1sided.RData")
cc_tm_PNC_bin5 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Temporal_bin5_clip5_1sided.RData")
...
# bin size = 7
arc_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Arcuate_bin7_clip5_1sided.RData")
ifo_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Inferior_Fronto_occipital_bin7_clip5_1sided.RData")
ilf_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Inferior_Longitudinal_bin7_clip5_1sided.RData")
parc_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Posterior_Arcuate_bin7_clip5_1sided.RData")
slf_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Superior_Longitudinal_bin7_clip5_1sided.RData")
unc_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Uncinate_bin7_clip5_1sided.RData")
vof_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Vertical_Occipital_bin7_clip5_1sided.RData")

cc_af_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Anterior_Frontal_bin7_clip5_1sided.RData")
cc_mot_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Motor_bin7_clip5_1sided.RData")
cc_occ_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Occipital_bin7_clip5_1sided.RData")
cc_orb_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Orbital_bin7_clip5_1sided.RData")
cc_pp_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Posterior_Parietal_bin7_clip5_1sided.RData")
cc_sf_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Superior_Frontal_bin7_clip5_1sided.RData")
cc_sp_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Superior_Parietal_bin7_clip5_1sided.RData")
cc_tm_PNC_bin7 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Temporal_bin7_clip5_1sided.RData")
...
# bin size = 10
arc_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Arcuate_bin10_clip5_1sided.RData")
ifo_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Inferior_Fronto_occipital_bin10_clip5_1sided.RData")
ilf_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Inferior_Longitudinal_bin10_clip5_1sided.RData")
parc_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Posterior_Arcuate_bin10_clip5_1sided.RData")
slf_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Superior_Longitudinal_bin10_clip5_1sided.RData")
unc_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Uncinate_bin10_clip5_1sided.RData")
vof_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Vertical_Occipital_bin10_clip5_1sided.RData")

cc_af_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Anterior_Frontal_bin10_clip5_1sided.RData")
cc_mot_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Motor_bin10_clip5_1sided.RData")
cc_occ_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Occipital_bin10_clip5_1sided.RData")
cc_orb_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Orbital_bin10_clip5_1sided.RData")
cc_pp_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Posterior_Parietal_bin10_clip5_1sided.RData")
cc_sf_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Superior_Frontal_bin10_clip5_1sided.RData")
cc_sp_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Superior_Parietal_bin10_clip5_1sided.RData")
cc_tm_PNC_bin10 <- readRDS("/cbica/projects/luo_wm_dev/two_axes/output/PNC/NEST/dti_md/Callosum_Temporal_bin10_clip5_1sided.RData")
