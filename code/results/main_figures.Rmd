...
NEST_PNC_CMot_pval <- readRDS(paste0(output_root, "/PNC/NEST/Callosum_Motor_bin5_clip5_1sided_end_compare.RData"))
print(NEST_PNC_CMot_pval$pval)
NEST_HCPD_CMot_pval <- readRDS(paste0(output_root, "/HCPD/NEST/Callosum_Motor_bin5_clip5_1sided_end_compare.RData"))
print(NEST_HCPD_CMot_pval$pval)
NEST_HBN_CMot_pval <- readRDS(paste0(output_root, "/HBN/NEST/Callosum_Motor_bin5_clip5_1sided_end_compare.RData"))
...
NEST_PNC_CMot_pval <- readRDS(paste0(output_root, "/PNC/NEST/Inferior_Fronto_occipital_bin5_clip5_1sided_end_compare.RData"))
print(NEST_PNC_CMot_pval$pval)
NEST_HCPD_CMot_pval <- readRDS(paste0(output_root, "/HCPD/NEST/Inferior_Fronto_occipital_bin5_clip5_1sided_end_compare.RData"))
print(NEST_HCPD_CMot_pval$pval)
NEST_HBN_CMot_pval <- readRDS(paste0(output_root, "/HBN/NEST/Inferior_Fronto_occipital_bin5_clip5_1sided_end_compare.RData"))
print(NEST_HBN_CMot_pval$pval)
