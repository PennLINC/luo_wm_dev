...
babs-init --where_project /cbica/projects/luo_wm_dev/input/PNC/derivatives \
    --project_name babs_qsirecon_pyafq_act_v2 \
    ...
    --list_sub_file /cbica/projects/luo_wm_dev/two_axes/input/PNC/subject_list/PNC_subject_list_babs.txt \
    --container_ds /cbica/projects/luo_wm_dev/two_axes/software/qsiprep/qsiprep-container-0-22-0 \
    --container_name qsiprep-0-22-0 \
    --container_config_yaml_file /cbica/projects/luo_wm_dev/two_axes/code/run_babs_qsirecon/babs_yaml_files/babs_qsiprep-0-22-0_qsirecon_mrtrix_ACT-hsvs_pyafq_singleshell_dti.yaml \
...
babs-init --where_project /cbica/projects/luo_wm_dev/input/HCPD/derivatives \
    ...
    --container_ds /cbica/projects/luo_wm_dev/two_axes/software/qsiprep/qsiprep-container-0-22-0 \
    --container_name qsiprep-0-22-0 \
    --container_config_yaml_file /cbica/projects/luo_wm_dev/two_axes/code/run_babs_qsirecon/babs_yaml_files/babs_qsiprep-0-22-0_qsirecon_mrtrix_ACT-hsvs_pyafq_dti.yaml \
    --type_session single-ses --type_system slurm 
...
babs-init --where_project /cbica/projects/luo_wm_dev/input/HBN/derivatives \
    --project_name babs_qsirecon_pyafq_allsubs_noACT_v2 \
    ...
    --container_ds /cbica/projects/luo_wm_dev/two_axes/software/qsiprep/qsiprep-container-0-22-0 \
    --container_name qsiprep-0-22-0 \
    --container_config_yaml_file /cbica/projects/luo_wm_dev/two_axes/code/run_babs_qsirecon/babs_yaml_files/babs_qsiprep-0-22-0_qsirecon_mrtrix_msmt_pyafq_dti.yaml \
    --type_session single-ses --type_system slurm 
