...
Output:
1) collated_tract_profiles_nocovbat_unc_cc.tsv for each dataset for subjects with ALL tracts (rows = 100 nodes * 28 tracts * X subjects; columns = 4 metrics + tractID + nodeID).
